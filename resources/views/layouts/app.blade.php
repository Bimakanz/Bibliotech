...
<!-- Tombol Logout -->
<button id="logoutTrigger" type="button"
  class="relative overflow-hidden inline-flex items-center gap-2 rounded-full border border-[#f97316]/50 bg-[#f97316] px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-white transition hover:bg-[#ea580c]">
  <span class="material-symbols-rounded text-base">logout</span>
  Keluar
  <!-- Cahaya hover -->
  <span class="absolute -left-full top-0 h-full w-2 bg-white opacity-30 transform -skew-x-12 transition-all duration-500 group-hover:left-full"></span>
</button>
